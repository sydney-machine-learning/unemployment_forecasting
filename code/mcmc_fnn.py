...
def main():
    ...
    for problem in xrange(2, 3): 
        ...
        MinCriteria = 0.00001  # stop when RMSE reaches MinCriteria ( problem dependent)
        ...
        burnin = 0 * numSamples  # use post burn in samples
        ...
        np.savetxt('mcmcresults/outres.txt', (rmse_tr, rmsetr_std, rmse_tes, rmsetest_std, accept_ratio), fmt='%1.5f')
